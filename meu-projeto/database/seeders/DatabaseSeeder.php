...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $cursos = [
            ...
            [
            'nome' => 'Curso de Química', 
            'sigla' => 'QUI', 
            'total_horas' => 70, 
            'nivel_id' => 3
            ],
            [
            'nome' => 'Curso de Biologia', 
            'sigla' => 'BIO', 
            'total_horas' => 90, 
            'nivel_id' => 4
            ],
        ...
        foreach ($documentos as $documento) {
            \App\Models\Documento::create($documento);
        }
        ...
        foreach ($comprovantes as $comprovante) {
            \App\Models\Comprovante::create($comprovante);
        }
        ...
        foreach ($declaracoes as $declaracao) {
            \App\Models\Declaracao::create($declaracao);
        }
    }
}
